...
import { getDataFavoriteProduct } from '../../redux/action/getDataTabProduct';
import ItemProduct from '../../components/ItemProduct';
import Fillter from '../../components/Fillter';

import { url } from '../../api/ApiService';

class FavoriteProduct extends PureComponent {
    ...
    componentDidMount() {
        this.props.getDataFavoriteProduct(this.state.value);
    }
    ...
    render() {
        const { isLoading, dataFavoriteProduct } = this.props;
        return (
...
const mapStateToProps = (state) => ({
    dataFavoriteProduct: state.dataFavoriteProduct.dataFavoriteProduct,
    isLoading: state.dataFavoriteProduct.loading
});

const mapDispatchToProps = (dispatch) => ({
    getDataFavoriteProduct: (value) => {
        dispatch(getDataFavoriteProduct(value));
    },
});
